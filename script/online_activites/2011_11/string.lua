...
tSTRING_201111_TABLE = {
	[1] = "Event ®· hÕt h¹n",
	[2] = "Nh©n vËt cÊp <color=green>73<color> trë lªn, ®· gia nhËp m«n ph¸i vµ häc ®­îc <color=green>1<color> kü n¨ng cÊp <color=green>55<color> míi cã thÓ tham gia",
	[3] = "Hµnh trang kh«ng gian kh«ng ®ñ, kh«ng thÓ nhËn.",
	[4] = "Tinh Th¹ch c¸c h¹ mang theo kh«ng ®ñ <color=green>200<color>",
	[5] = "Mçi nh©n vËt mçi ngµy nhËn phÇn th­ëng mõng n¨m míi giíi h¹n <color=green>3<color> lÇn trong 1 ngµy",
...
tSTRING_MISSIONARIES_TABLE = {
	...
	[9] = "PhÇn th­ëng ®· nhËn <color=green>%d<color>/<color=green>%d<color> phÇn.",
	[10] = "Xin chóc mõng tay ®ua kiÖt xuÊt <%s> ®· c¸n ®İch vµ nhËn ®­îc phÇn quµ ®Æc biÖt cña ¤ng Giµ Noel, sè quµ cßn l¹i lµ <%d/%d> phÇn.",
	[11] = "ThiÕu hiÖp ®· nhËn phÇn th­ëng cña «ng giµ Noel råi.",
}
...
tSTRING_DECORATETREE_TABLE = {
	...
	[5] = "ThiÕu hiÖp ®· ®Æt xuèng 1 c©y th«ng noel.",
	[6] = "Hµnh trang mang theo kh«ng ®ñ <color=green>%d<color> Lé Thñy",
	[7] = "Th«ng Noel cÊp %s",
	[8] = "Gi·n c¸ch thêi gian trang trİ c©y lµ <color=green>%d<color> phót",
	[9] = "<color=green>%s:<color> Merry Christmass!!!",
	[10] = "ThiÕu hiÖp trang trİ c©y th«ng noel giíi h¹n <color=green>%d<color> c©y trong 1 ngµy",
	[11] = "Kh«ng cã phÇn th­ëng ®Ó nhËn.",
	[12] = "ThiÕu hiÖp vÉn ch­a nhËn phÇn th­ëng lÇn tr­íc.",
}