...
t_switch_config =
{
	...
	{12, 0, "TongMelee"},
	{13, 0, "CardVip"},
	{14, 0, "GemSystem", "HÖ thèng §¸ Quý"}, -- tat duc lo trang bi
	{15,0, "TaiYi", "¶i PhÇn Thiªn L©m"},
	{16, 0, "StateChess", "Tr­îng KiÕm Thiªn Nhai"},
...
function _check_subsystem_open(nSubSystemId, nNotifyType)
	...
	if 1 ~= bIsOpen and nNotifyType then
		...
		local szMsg = format("[%s]%s",szSystemName, "T¹m thêi ch­a mo~ xin vui lßng ®îi")
...
SPECIAL_SWITCH_KS_GM 			= 0 --KSÄÚ²¿²âÊÔ°æ±¾
SPECIAL_SWITCH_EXP_SVR 			= 0 --ÌåÑé·þÎñÆ÷°æ±¾ 1 la mo gm item, 0 la tat
SPECIAL_SWITCH_INTER_TEST_SVR	= 0 --ÄÚÍø²âÊÔ·þÎñÆ÷
