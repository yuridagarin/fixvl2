...
tRewardRoute =
{
	[1] 	=  {"ThiÕu L©m tôc gia", 1},
	[2] 	=  {"ThiÕu L©m thiÒn t¨ng", 3},
	[3] 	=  {"ThiÕu L©m vâ t«ng", 5},
	[4] 	=  {"Vâ §ang ®¹o gia", 17},
	[5] 	=  {"Vâ §ang tôc gia", 19},
	[6] 	=  {"Nga My phËt gia", 9},
	[7] 	=  {"Nga My tôc gia", 11},
	[8] 	=  {"C¸i Bang tÜnh y", 13},
	[9] 	=  {"C¸i Bang « y", 15},
	[10] 	=  {"§­êng M«n", 7},
	[11] 	=  {"D­¬ng Gia th­¬ng", 21},
	[12] 	=  {"D­¬ng Gia cung", 23},
	[13] 	= {"Ngò §éc hiÖp ®éc", 25},
	[14] 	= {"Ngò §éc tµ ®éc", 27},
	[15] 	= {"C«n l«n thiªn s­", 180},
	[16] 	= {"Thuý yªn vò tiªn", 188},
	[17] 	= {"Thuý yªn linh n÷", 190},
}
...
--		end;
		-- if CheckXacThuc() == 0 then
					-- Msg2Player("Tµi kho¶n ch­a x¸c thùc chØ nhËn ®­îc kinh nghiÖm. Xin thÝ chñ h·y dõng tay.");
		-- else 
					...
					if nRandomNum <= 20 then
						if AddItem(2,2,8,3) == 1 then
							...
							WriteLog("[Ho¹t ®éng trång c©y Th¸i H­]:"..GetName().."NhËn ®­îc 3 Thiªn Th¹ch");
						end;		
					end;
					...
					if nRandomNum <= 20 then
						...
						if AddItem(2,1,nWhat,1) == 1 then
							...
							WriteLog("[Ho¹t ®éng trång c©y Th¸i H­]:"..GetName().."NhËn ®­îc 1 Th¸i H­ B¸t Qu¸i Bµi");
						end;		
					end;
					...
					if nRandomNum <= 3  then
						...
						Msg2Player("B¹n ®· nhËn ®­îc 1 MËt tÞch m«n ph¸i "..tRewardRoute[nRandBook1][1]);
						WriteLog("[Ho¹t ®éng trång c©y Th¸i H­]:"..GetName().." ®· nhËn ®­îc 1 MËt tÞch m«n ph¸i "..tRewardRoute[nRandBook1][1]);
					elseif  nRandomNum <= 7 then
						if AddItem(0,107,66,1) == 1 then
							Msg2Player("B¹n nhËn ®­îc 1 quyÓn ".."Chiªm Y MËt tÞch");
							WriteLog("[Ho¹t ®éng trång c©y Th¸i H­]:"..GetName().."Thu ®­îc 1 ".."Chiªm Y MËt tÞch");
						end;		
					elseif nRandomNum <= 10 then
						if AddItem(0,107,65,1) == 1 then
							Msg2Player("B¹n nhËn ®­îc 1 quyÓn ".."Tö Hµ MËt tÞch");
							WriteLog("[Ho¹t ®éng trång c©y Th¸i H­]:"..GetName().."Thu ®­îc 1 ".."Tö Hµ MËt tÞch");
						end;		
					elseif nRandomNum <= 15 then
						if AddItem(0,107,64,1) == 1 then
							Msg2Player("B¹n nhËn ®­îc 1 quyÓn ".."Thiªn Hµ MËt tÞch");
							WriteLog("[Ho¹t ®éng trång c©y Th¸i H­]:"..GetName().."Thu ®­îc 1 ".."Thiªn Hµ MËt tÞch");
						end;		
					end;
		-- end
		...
		-- if nRandomNum <= 5 and tRewardRoute[mRoute] then
			...
			-- Msg2Player("B¹n ®· nhËn ®­îc 1 MËt tÞch m«n ph¸i "..tRewardRoute[mRoute][1]);
			-- WriteLog("[Ho¹t ®éng trång c©y Th¸i H­]:"..GetName().." ®· nhËn ®­îc 1 MËt tÞch m«n ph¸i "..tRewardRoute[mRoute][1]);
		-- end;
		...
		gf_EventGiveCustomAward(2,80000,0,"Bat Nha Lon","nhËn")
