...
--		Talk(1,"","<color=green>"..g_sNpcName.."<color>: TuÇn ®Çu tiªn HiÖp §éc kh«ng thÓ tham gia!");
--		return 0;
--	end;
...
--				"Ta muèn ®æi 100000 ®iÓm tÝch lòy lÊy H¹ y cña Tµng KiÕm cÊp 70/want_cangjian_equip",
				"Ta muèn ®æi 50000 ®iÓm tÝch lòy lÊy LÖnh bµi bang héi/want_ling_pai",
				"Ta muèn ®æi 4000 ®iÓm tÝch lòy lÊy MËt tÞch m«n ph¸i/doi_mat_tich_voz",
				"Ta muèn ®æi 1000 ®iÓm tÝch lòy lÊy 10 mtt/doi_mtt_voz",
				"Ta muèni 2000 ®iÓm tÝch lòy lÊy ®iÓm kinh nghiÖm/want_exp_award",
				"Ta muèn ®æi 2000 ®iÓm tÝch lòy lÊy 1 b¶n ®óc thÇn binh/doi_mdtb_voz",
				"Quay l¹i néi dung tr­íc./main",
				"KÕt thóc ®èi tho¹i/nothing",
				}
...
function doi_mdtb_voz()
	...
	Say("<color=green>"..g_sNpcName.."<color>: §æi <color=yellow>1 b¶n ®óc thÇn binh<color> cÇn <color=yellow>1000 ®iÓm tÝch lòy<color>, b¹n x¸c nhËn muèn ®æi?",getn(selTab),selTab);
end;
...
function lay_mdtb_voz()
	...
	if nRetCode == 1 then
		Msg2Player("B¹n ®· ®æi 1 b¶n ®óc thÇn binh");
		WriteLog("[phÇn th­ëng chiÕn trËn]:"..GetName().." ®· ®æi 1 b¶n ®óc thÇn binh");
	else
		WriteLog("[phÇn th­ëng bÞ lçi]"..GetName().."Khi ®æi 1 b¶n ®óc thÇn binh AddItem b¸o lçi, nRetCode:"..nRetCode);
	end;
end;
...
function doi_mtt_voz()
	...
	Say("<color=green>"..g_sNpcName.."<color>: §æi <color=yellow>10 mtt<color> cÇn <color=yellow>2000 ®iÓm tÝch lòy<color>, b¹n x¸c nhËn muèn ®æi?",getn(selTab),selTab);
end;
...
function lay_mtt_voz()
	...
	if nRetCode == 1 then
		Msg2Player("B¹n ®· ®æi 10 mtt");
		WriteLog("[phÇn th­ëng chiÕn trËn]:"..GetName().." ®· ®æi 10 mtt");
	else
		WriteLog("[phÇn th­ëng bÞ lçi]"..GetName().."Khi ®æi 10mtt AddItem b¸o lçi, nRetCode:"..nRetCode);
	end;
end;

function doi_mat_tich_voz()
	local selTab = {
			"§ång ý/lay_mat_tich_voz",
			"Hñy bá/nothing",
			}
	Say("<color=green>"..g_sNpcName.."<color>: §æi <color=yellow>MËt tÞch m«n ph¸i<color> cÇn <color=yellow>3000 ®iÓm tÝch lòy<color>, b¹n x¸c nhËn muèn ®æi?",getn(selTab),selTab);
end;
...
t_TUOGUAN_HIG_VOZ = {
	[2] = {"Kim Cang B¸t Nh· Ch©n QuyÓn", {0,107,204,1,1}},
	[3] = {"V« TrÇn Bå §Ò Ch©n QuyÓn",{0,107,206,1,1}},
	[4] = {"TiÒm Long Tóc DiÖt Ch©n QuyÓn",{0,107,205,1,1}},
	[6] = {"Thiªn La Liªn Ch©u Ch©n QuyÓn",{0,107,207,1,1}},
	[8] = {"Nh­ ý Kim §Ønh Ch©n QuyÓn",{0,107,208,1,1}},
	[9] = {"BÝch H¶i TuyÖt ¢m Ch©n QuyÓn",{0,107,209,1,1}},
	[11] = {"Hçn §én TrÊn Nh¹c Ch©n QuyÓn",{0,107,210,1,1}},
	[12] = {"Quú Thiªn Du Long Ch©n QuyÓn",{0,107,211,1,1}},
	[14] = {"HuyÒn ¶nh Mª T«ng Ch©n QuyÓn",{0,107,212,1,1}},
	[15] = {"Qu©n Tö §íi Phong Ch©n QuyÓn",{0,107,213,2,1}},
	[17] = {"TrÊn Qu©n Phi Long Th­¬ng Ch©n QuyÓn",{0,107,214,1,1}},
	[18] = {"Xuyªn V©n L¹c Hång Ch©n QuyÓn",{0,107,215,1,1}},
	[20] = {"HuyÒn Minh Phong Ma Ch©n QuyÓn",{0,107,216,1,1}},
	[21] = {"Linh Cæ HuyÒn Tµ Ch©n QuyÓn",{0,107,217,2,1}},
	[23] = {"Cöu Thiªn Phong L«i Ch©n QuyÓn", {0,107, 218,1,1}},		
	[29] = {"Hång TrÇn Tóy Méng Ch©n QuyÓn", {0,107, 222,1,1}},		
	[30] = {"Phong Hoa Thiªn DiÖp Ch©n QuyÓn", {0,107, 223,1,1}},			
};
function lay_mat_tich_voz()
	...
	if nRetCode == 1 then
		Msg2Player("B¹n ®· ®æi mét MËt tÞch m«n ph¸i");
		WriteLog("[phÇn th­ëng chiÕn trËn]:"..GetName().." ®· ®æi mét MËt tÞch m«n ph¸i");
	else
