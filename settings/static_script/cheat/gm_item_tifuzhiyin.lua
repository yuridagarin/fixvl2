...
if nRoute <= 0 then
		...
		tSay = {
			...
			"NhËn Bé DiÖu D­¬ng +15/Get_YaoYang_10",
			"NhËn trang bÞ Thiªn §Þa NhËt NguyÖt/Get_trangbivip",
...
function Get_Gem()
	...
	WriteLogEx("Get_Gem","NhËn ®¸ quý", 100, "HuyÕtTrÝchTh¹ch");
	...
	WriteLogEx("Get_Gem","NhËn ®¸ quý", 100, "NguyÖtB¹chTh¹ch");
	...
	WriteLogEx("Get_Gem","NhËn ®¸ quý", 100, "Hæ Ph¸ch Th¹ch ");
	...
	WriteLogEx("Get_Gem","NhËn ®¸ quý", 100, "H¾c DiÖu Th¹ch ");
end
function an_reborn()
